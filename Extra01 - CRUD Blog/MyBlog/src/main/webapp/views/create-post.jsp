  ...
  <body>
    ...
    <section class="py-5">
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            <h3 class="h4 mb-4">Create a new post</h3>
            <form class="mb-5" action="/create" method="post">
              <div class="row gy-3">
                ...
                <div class="col-lg-12">
                  <input class="form-control" type="text" name="thumbnail" placeholder="Image">
                </div>
                <div class="col-lg-12">
                  <textarea class="form-control" name="content" rows="5" placeholder="Content goes here"></textarea>
                </div>
                <div class="col-lg-12">
