      ...
      <div class="swiper destinations-slider swiper-padding">
        <div class="swiper-wrapper">
          <c:forEach var="post" items="${posts}">
            <div class="swiper-slide h-auto"><a class="destination d-flex align-items-end bg-center bg-cover" href="/post?id=${post.id}" style="background: url(${post.thumbnail})">
    ...
    <section class="py-5">
      <div class="container py-4">
        ...
        <div class="row align-items-stretch gx-lg-0">
          ...
          <div class="col-lg-6 order-1 order-lg-2"><a class="d-block h-100 bg-center bg-cover" href="../post.html" style="background: url(../img/travel-home-divider.jpg)"></a></div>
        </div>
      </div>
    </section>
    <!-- Instagram section-->
    ...
    <section class="py-5 bg-light">
      <div class="container py-4">
        ...
        <div class="row text-center">
          <div class="col-lg-3 col-md-6"><a class="text-reset" href="../post.html"><img class="mb-4" src="../img/bag.png" alt="" height="150">
              <h3 class="h5">Backpack</h3>
              <p class="text-sm text-muted">Deserunt et ad culpa culpa dolore.</p></a></div>
          <div class="col-lg-3 col-md-6"><a class="text-reset" href="../post.html"><img class="mb-4" src="../img/camera.png" alt="" height="150">
              <h3 class="h5">Camera</h3>
              <p class="text-sm text-muted">Consectetur ex sunt duis minim quis dolor.</p></a></div>
          <div class="col-lg-3 col-md-6"><a class="text-reset" href="../post.html"><img class="mb-4" src="../img/glasses.png" alt="" height="150">
              <h3 class="h5">Sunglasses</h3>
              <p class="text-sm text-muted">Deserunt et ad culpa culpa dolore.</p></a></div>
          <div class="col-lg-3 col-md-6"><a class="text-reset" href="../post.html"><img class="mb-4" src="../img/headphone.png" alt="" height="150">
      ...
      <div class="container py-4">
        ...
        <div class="row text-center gy-4">
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              ...
              <p class="text-muted text-sm">Restaurants Destinations</p></a></div>
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              <svg class="svg-icon mb-3 svg-icon-big svg-icon-light text-primary">
                <use xlink:href="#paper-bag-1"> </use>
              </svg>
              <h3 class="h5">Markets</h3>
              <p class="text-muted text-sm">Markets Destinations</p></a></div>
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              <svg class="svg-icon mb-3 svg-icon-big svg-icon-light text-primary">
                <use xlink:href="#special-price-1"> </use>
              </svg>
              <h3 class="h5">Low budget</h3>
              <p class="text-muted text-sm">Low budget Destinations</p></a></div>
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              <svg class="svg-icon mb-3 svg-icon-big svg-icon-light text-primary">
                <use xlink:href="#movie-camera-1"> </use>
              </svg>
              <h3 class="h5">Cinemas</h3>
              <p class="text-muted text-sm">Cinemas Destinations</p></a></div>
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              <svg class="svg-icon mb-3 svg-icon-big svg-icon-light text-primary">
                <use xlink:href="#beach-1"> </use>
              </svg>
              <h3 class="h5">Beaches</h3>
              <p class="text-muted text-sm">Beaches Destinations</p></a></div>
          <div class="col-lg-2 col-md-4 col-sm-6"><a class="reset-anchor d-block" href="../listing.html">
              <svg class="svg-icon mb-3 svg-icon-big svg-icon-light text-primary">
                <use xlink:href="#camping-1"> </use>
              </svg>
              <h3 class="h5">Camping</h3>
              <p class="text-muted text-sm">Camping Destinations</p></a></div>
        </div>
      </div>
    </section>
    <!-- Sponsors section-->
