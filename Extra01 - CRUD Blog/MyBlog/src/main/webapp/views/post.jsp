...
<html>
  ...
  <body>
    ...
    <section class="py-5">
      ...
      </div><img class="w-100 py-5" src="${post.thumbnail}" alt="">
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            ...
            <div class="p-4 bg-light mb-5">
              <ul class="list-inline mb-0">
                <li class="list-inline-item me-2 pe-lg-2"><a class="tag reset-anchor" href="/edit?id=${post.id}"><i class="fas fa-bookmark text-primary me-2"></i>Edit Post</a></li>
                <li class="list-inline-item me-2 pe-lg-2"><a class="tag reset-anchor" href="/delete?id=${post.id}"><i class="fas fa-bookmark text-primary me-2"></i>Delete Post</a></li>
              </ul>
            </div>
